...
class ScreenRuntimeTests(unittest.TestCase):
    ...
    def test_clean_viewer_and_landing_have_no_legacy_novnc_pages(self):
        ...
        self.assertIn('#mobile-keyboard-button,#mobile-clipboard-button{display:grid;place-items:center;width:48px;height:44px;min-width:48px;min-height:44px', viewer)
        self.assertIn('background:#111827e8;color:#f8fafc;box-shadow:0 8px 24px #0008', viewer)
        self.assertIn('#mobile-keyboard-button svg,#mobile-clipboard-button svg{display:block;width:20px;height:20px}', viewer)
