...
class ScreenRuntimeTests(unittest.TestCase):
    ...
    def test_clean_viewer_and_landing_have_no_legacy_novnc_pages(self):
        ...
        self.assertIn('#mobile-keyboard-button,#mobile-pointer-button,#mobile-clipboard-button{display:grid;place-items:center;width:48px;height:44px;min-width:48px;min-height:44px', viewer)
